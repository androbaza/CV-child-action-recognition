...
<p align="center">
  <img width="400" src="https://github.com/androbaza/CV-child-action-recognition/blob/master/test-results/i3D-rgb/i3D-conf-mat.png">
</p>

Confusion matrix with the TPN model, rgb frames (96.83% accuracy):

<p align="center">
  <img width="400" src="https://github.com/androbaza/CV-child-action-recognition/blob/master/test-results/TPN-rgb/TPN-conf-mat.png">
</p>
...
Confusion matrix with the TSN model, video (94.44% accuracy):
...
Confusion matrix with the TSM model, video (93.65% accuracy):
...
Confusion matrix with the R2+1D model, optical flow (92.68% accuracy):

<p align="center">
  <img width="400" src="https://github.com/androbaza/CV-child-action-recognition/blob/master/test-results/MMaction-R2%2B1D-flow/R2%2B1D-conf-mat.png">
</p>

Confusion matrix with the SlowFast model, video (91.27% accuracy):
